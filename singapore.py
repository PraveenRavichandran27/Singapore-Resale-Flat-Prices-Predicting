...
data = pd.read_csv('C:/Users/HP/Desktop/Data Scientist/project/singapore resale flat price prediction/New data/mrt-lat&lon.csv')
...
image_link = "https://images.pexels.com/photos/777059/pexels-photo-777059.jpeg?cs=srgb&dl=pexels-kin-pastor-251088-777059.jpg&fm=jpg"
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                ...
                st.write('## :blue[Predicted resale price:] ', np.exp(new_pred))

    except Exception as e:
        st.write("#### :blue[Enter the above values to get the predicted resale price of the flat]")
